"""
ChannelOS — Configuration des niches
=====================================
Chaque niche a :
- un nom, une description d'audience
- des angles thématiques préférés
- des affiliés recommandés
- les langues cibles
- le profil vocal (voix Azure)

Ajoute une niche = ChannelOS peut alimenter une nouvelle chaîne.
"""
